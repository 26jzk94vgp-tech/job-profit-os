    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-4xl mx-auto px-6 py-8 space-y-4">
        ...
        {totalReceivable > 0 && (
          <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-4">
            ...
            {unpaidInvoices.slice(0, 3).map((e: any) => (
              <div key={e.id} className="flex justify-between text-sm bg-white rounded-lg px-3 py-2 mt-2 border border-gray-100">
                <span className="text-gray-900 font-medium">{e.jobs?.name} — {e.description || (lang === 'zh' ? '发票' : 'Invoice')}</span>
        ...
        <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
          ...
          <Link href="/tax" className="md:hidden flex justify-between items-center px-6 py-4 hover:bg-gray-50">
            <div className="flex items-center gap-3">
              <span className="text-2xl">📊</span>
              <div>
