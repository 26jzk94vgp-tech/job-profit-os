          ...
          {type === 'material' && (
            <>
              ...
              <div className="flex gap-3">
                ...
                <div className="w-24 relative"><label className="text-gray-700 text-sm font-medium">{t.unit}</label><input className="w-full border border-gray-200 dark:border-[#3A3A3C] rounded-lg p-3 mt-1 text-gray-900 dark:text-[#F2F2F7] dark:bg-[#3A3A3C] outline-none" value={unit} onChange={(e) => setUnit(e.target.value)} onFocus={() => setUnitOpen(true)} onBlur={() => setTimeout(() => setUnitOpen(false), 150)} />{unitOpen && <div className="absolute z-30 left-0 w-40 mt-1 bg-white dark:bg-[#2C2C2E] border border-gray-200 dark:border-[#3A3A3C] rounded-lg shadow-lg overflow-hidden text-gray-900 dark:text-[#F2F2F7]"><button type="button" key="sqm" onMouseDown={(e) => { e.preventDefault(); setUnit('sqm'); setUnitOpen(false) }} className="block w-full text-left px-2 py-1.5 text-sm hover:bg-gray-100 dark:hover:bg-[#48484A]">sqm <span className="text-gray-400 text-xs">平方米</span></button><button type="button" key="qbm" onMouseDown={(e) => { e.preventDefault(); setUnit('qbm'); setUnitOpen(false) }} className="block w-full text-left px-2 py-1.5 text-sm hover:bg-gray-100 dark:hover:bg-[#48484A]">qbm <span className="text-gray-400 text-xs">立方米</span></button><button type="button" key="L" onMouseDown={(e) => { e.preventDefault(); setUnit('L'); setUnitOpen(false) }} className="block w-full text-left px-2 py-1.5 text-sm hover:bg-gray-100 dark:hover:bg-[#48484A]">L <span className="text-gray-400 text-xs">升</span></button><button type="button" key="KL" onMouseDown={(e) => { e.preventDefault(); setUnit('KL'); setUnitOpen(false) }} className="block w-full text-left px-2 py-1.5 text-sm hover:bg-gray-100 dark:hover:bg-[#48484A]">KL <span className="text-gray-400 text-xs">千升</span></button><button type="button" key="KG" onMouseDown={(e) => { e.preventDefault(); setUnit('KG'); setUnitOpen(false) }} className="block w-full text-left px-2 py-1.5 text-sm hover:bg-gray-100 dark:hover:bg-[#48484A]">KG <span className="text-gray-400 text-xs">千克</span></button><button type="button" key="LM" onMouseDown={(e) => { e.preventDefault(); setUnit('LM'); setUnitOpen(false) }} className="block w-full text-left px-2 py-1.5 text-sm hover:bg-gray-100 dark:hover:bg-[#48484A]">LM <span className="text-gray-400 text-xs">米</span></button><button type="button" key="EA" onMouseDown={(e) => { e.preventDefault(); setUnit('EA'); setUnitOpen(false) }} className="block w-full text-left px-2 py-1.5 text-sm hover:bg-gray-100 dark:hover:bg-[#48484A]">EA <span className="text-gray-400 text-xs">个</span></button></div>}</div>
              </div>
