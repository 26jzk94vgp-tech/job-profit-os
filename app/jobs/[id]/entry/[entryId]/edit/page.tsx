          ...
          {type === 'material' && (
            <>
              ...
              <div className="flex gap-3">
                ...
                <div className="w-24"><label className="text-gray-700 text-sm font-medium">{t.unit}</label><datalist id="cimoUnits"><option value="sqm">平方米</option><option value="qbm">立方米</option><option value="L">升</option><option value="KL">千升</option><option value="KG">千克</option><option value="LM">米</option><option value="EA">个</option></datalist><input className="w-full border border-gray-200 dark:border-[#3A3A3C] rounded-lg p-3 mt-1 text-gray-900 dark:text-[#F2F2F7] dark:bg-[#3A3A3C] outline-none" list="cimoUnits" value={unit} onChange={(e) => setUnit(e.target.value)} /></div>
              </div>
