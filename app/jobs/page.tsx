    ...
    <div className="min-h-screen bg-gray-50 pb-20">
      <nav className="bg-white border-b border-gray-200 px-6 py-4 hidden md:block">
        <div className="max-w-4xl mx-auto flex items-center justify-between">
          <h1 className="font-semibold text-gray-900 dark:text-[#F2F2F7]">{lang === 'zh' ? '工单列表' : 'Jobs'}</h1>
      ...
      <main className="max-w-4xl mx-auto px-6 py-6 space-y-4">
          ...
          <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
            ...
            <div className="divide-y divide-gray-100">
              {activeJobs.map((job: any) => {
                ...
                return (
                  <Link href={'/jobs/' + job.id} key={job.id} className="flex justify-between items-center px-6 py-4 hover:bg-gray-50 dark:bg-[#1C1C1E]">
                    <div>
        ...
        {completedJobs.length > 0 && (
          <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
            <div className="px-6 py-3 bg-green-50 border-b border-gray-100 dark:border-[#3A3A3C]">
        ...
        <Link href="/archive" className="flex items-center justify-between px-6 py-4 bg-white rounded-xl border border-gray-200 hover:bg-gray-50 dark:bg-[#1C1C1E]">
