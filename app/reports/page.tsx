      ...
      <nav className="bg-white dark:bg-[#2C2C2E] border-b border-gray-200 px-6 py-4 hidden md:block">
        <div className="max-w-4xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h1 className="font-semibold text-gray-900 dark:text-[#F2F2F7]">{lang === 'zh' ? '税务报告' : 'Tax Report'}</h1>
          </div>
      ...
      <main className="max-w-4xl mx-auto px-6 py-8 space-y-6">
        ...
        <div className="bg-white dark:bg-[#2C2C2E] rounded-xl border border-gray-200 dark:border-[#3A3A3C]">
          <div className="px-6 py-4 border-b border-gray-100 dark:border-[#3A3A3C]">
            <h2 className="font-semibold text-gray-900 dark:text-[#F2F2F7]">{lang === 'zh' ? 'GST 汇总 (BAS)' : 'GST Summary (BAS)'}</h2>
          ...
          <div className="divide-y divide-gray-100">
            ...
            <div className="px-6 py-4 flex justify-between items-center bg-gray-50 dark:bg-[#1C1C1E]">
              <div>
                <p className="font-bold text-gray-900 dark:text-[#F2F2F7]">{lang === 'zh' ? '应缴ATO净GST' : 'Net GST Payable to ATO'}</p>
        ...
        <div className="bg-white dark:bg-[#2C2C2E] rounded-xl border border-gray-200 dark:border-[#3A3A3C]">
          <div className="px-6 py-4 border-b border-gray-100 dark:border-[#3A3A3C]">
            <h2 className="font-semibold text-gray-900 dark:text-[#F2F2F7]">{lang === 'zh' ? 'ATO分类明细' : 'ATO Category Breakdown'}</h2>
          ...
          <div className="divide-y divide-gray-100">
            ...
            {Object.keys(categoryTotals).length > 0 && (
              <div className="px-6 py-4 flex justify-between items-center bg-gray-50 dark:bg-[#1C1C1E]">
                <p className="font-bold text-gray-900 dark:text-[#F2F2F7]">💰 {lang === 'zh' ? '应税利润' : 'Taxable Profit'}</p>
                <span className={
