        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700">
          ...
          <div className="divide-y divide-gray-100">
            <div className="px-6 py-4 flex justify-between items-center">
              <div>
                <p className="font-medium text-gray-900 dark:text-white">{lang === 'zh' ? '已收GST' : 'GST Collected'}</p>
            ...
            <div className="px-6 py-4 flex justify-between items-center">
              <div>
                <p className="font-medium text-gray-900 dark:text-white">{lang === 'zh' ? '已付GST (进项税抵扣)' : 'GST Paid (Input Tax Credits)'}</p>
            ...
            <div className="px-6 py-4 flex justify-between items-center bg-gray-50 dark:bg-gray-900">
              <div>
          ...
          <div className="divide-y divide-gray-100">
            ...
            {Object.entries(categoryTotals).filter(([cat]) => cat === 'other_income').map(([cat, total]) => (
              <div key={cat} className="px-6 py-4 flex justify-between items-center">
                <div>
                  <p className="font-medium text-gray-900 dark:text-white">{lang === 'zh' ? categoryLabels[cat]?.zh : categoryLabels[cat]?.en || cat}</p>
