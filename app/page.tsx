  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
      ...
      <main className="max-w-4xl mx-auto px-4 pt-20 pb-8 md:pt-8 space-y-6">
        {/* Header */}
        <div>
          <h1 className="text-[20px] md:text-[34px] font-bold tracking-tight text-gray-900 dark:text-white leading-tight">{t.dashboard}</h1>
        ...
        <div className="grid grid-cols-3 gap-4">
          <div className="bg-white dark:bg-[#2C2C2E] rounded-2xl border border-gray-200 dark:border-transparent p-5 space-y-1">
            ...
            <p className="text-[20px] md:text-[34px] font-bold text-gray-900 dark:text-white leading-tight">{jobs.length}</p>
          ...
          <div className="bg-white dark:bg-[#2C2C2E] rounded-2xl border border-gray-200 dark:border-transparent p-5 space-y-1">
            ...
            <p className="text-[20px] md:text-[34px] font-bold text-gray-900 dark:text-white leading-tight">${totalRevenue.toLocaleString()}</p>
          ...
          <div className="bg-white dark:bg-[#2C2C2E] rounded-2xl border border-gray-200 dark:border-transparent p-5 space-y-1">
            ...
            <p className={`text-[20px] md:text-[34px] font-bold leading-tight ${totalProfit >= 0 ? 'text-[#30D158]' : 'text-[#FF453A]'}`}>
          ...
          <div className="bg-white dark:bg-[#2C2C2E] rounded-2xl border border-gray-200 dark:border-transparent p-5 space-y-1">
            ...
            <p className={`text-[20px] md:text-[34px] font-bold leading-tight ${totalReceivable > 0 ? 'text-[#FF9F0A]' : 'text-gray-900 dark:text-white'}`}>
          ...
          <div className="bg-white dark:bg-[#2C2C2E] rounded-2xl border border-gray-200 dark:border-transparent p-5 space-y-1">
            ...
            <p className="text-[20px] md:text-[34px] font-bold text-gray-900 dark:text-white leading-tight">
          ...
          <div className="bg-white dark:bg-[#2C2C2E] rounded-2xl border border-gray-200 dark:border-transparent p-5 space-y-1">
            ...
            <p className="text-[20px] md:text-[34px] font-bold text-[#FF453A] leading-tight">
