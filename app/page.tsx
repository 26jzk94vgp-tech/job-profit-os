                      ...
                      return(
                        <tr key={job.id} style={{borderTop:i>0?`1px solid ${T.borderSub}`:'none',cursor:'pointer'}}
                          ...
                          <td style={{padding:'11px 16px'}}>
                            <Link href={`/jobs/${job.id}`} style={{fontSize:'15px',fontWeight:500,color:T.primary,textDecoration:'none'}}>{zh?job.name:(job.name.includes('的工单')?job.name.replace('的工单','Job'):job.name+' Job')}</Link>
                          </td>
                          <td style={{padding:'11px 16px'}}>
