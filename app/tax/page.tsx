    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-4xl mx-auto px-6 py-8 space-y-4">
        ...
        <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
          ...
          <Link href="/tax/bas" className="flex justify-between items-center px-6 py-4 hover:bg-gray-50 dark:hover:bg-[#3A3A3C] border-b border-gray-100">
            <div className="flex items-center gap-3">
              <span className="text-2xl">🧾</span>
              <div>
                <p className="font-medium text-gray-900">{lang === 'zh' ? 'BAS 报表（季度 GST）' : 'BAS Report (Quarterly GST)'}</p>
                <p className="text-gray-400 text-xs">{lang === 'zh' ? '净 GST' : 'Net GST'}: ${netGst.toFixed(2)}</p>
              </div>
            </div>
            <span className="text-gray-400">→</span>
          </Link>
