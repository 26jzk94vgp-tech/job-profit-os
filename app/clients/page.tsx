    ...
    <div className="min-h-screen bg-gray-50 dark:bg-[#1C1C1E]">
      <nav className="bg-white border-b border-gray-200 px-6 py-4 hidden md:block">
        <div className="max-w-4xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h1 className="font-semibold text-gray-900 dark:text-[#F2F2F7]">{lang === 'zh' ? '客户' : 'Clients'}</h1>
          </div>
      ...
      <main className="max-w-4xl mx-auto px-6 py-8">
        ...
        <div className="bg-white rounded-xl border border-gray-200 dark:border-[#3A3A3C]">
          {!clients.length && <div className="px-6 py-16 text-center text-gray-400 dark:text-[#636366]">{lang === 'zh' ? '还没有客户' : 'No clients yet.'}</div>}
          <div className="divide-y divide-gray-100">
            {clients.map((client) => {
              ...
              return (
                <div key={client.id}>
                  <div className="px-6 py-4 cursor-pointer hover:bg-gray-50 dark:bg-[#1C1C1E]" onClick={() => setExpanded(isExpanded ? null : client.id)}>
                    ...
                    <div className="flex justify-between items-center mt-2">
                      <div className="flex gap-3 text-xs text-gray-400 dark:text-[#636366]">
                  ...
                  {isExpanded && clientJobs.length > 0 && (
                    <div className="bg-gray-50 border-t border-gray-100 dark:border-[#3A3A3C]">
                      {clientJobs.map(job => (
                  ...
                  {isExpanded && getClientQuotes(client.id, client.name).length > 0 && (
                    <div className="bg-yellow-50 border-t border-gray-100 dark:border-[#3A3A3C]">
