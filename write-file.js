...
`
fs.writeFileSync('app/quotes/new/page.tsx', part1)
...
const existing = require('fs').readFileSync('app/quotes/new/page.tsx', 'utf8')
require('fs').writeFileSync('app/quotes/new/page.tsx', existing + part2)
